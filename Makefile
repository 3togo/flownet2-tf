...
TF_LINK=`python -c 'import tensorflow as tf; print(tf.sysconfig.get_link_flags())'`
ifndef CUDA_HOME
...
CC        = gcc-6 -O2 -pthread
CXX       = g++-6
GPUCC     = nvcc -expt-relaxed-constexpr -DNDEBUG
CFLAGS    = -std=c++11 -I$(TF_INC) -I"$(CUDA_HOME)/include" -I$(CUDA_HOME)/../ -DGOOGLE_CUDA=1 -I$TF_INC/external/nsync/public -L$TF_LIB
GPUCFLAGS = -c
LFLAGS    = -pthread -shared -fPIC -L$TF_LINK
